...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Day\Documents\python\gerador_de_senhas'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Day\Documents\python\gerador_de_senhas\Scripts\deactivate.nu'
